...
df = pd.read_csv("./CATMAN_1003/WK0_MERCATO_CATMAN.csv",sep=';',low_memory=False,encoding="latin1")
...
pt.frame_to_hyper(df, "./CATMAN_1003/Tabelle analisi mercato.hyper", table=table, process_params=params)
